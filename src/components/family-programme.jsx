...
const FamilyProgramme = ({ onClick }) => {
  return (
    <>
      ...
      <p>I run a one-day education/family programme to help create awareness about addiction and its effects on the addicted person and their family.  The programme is scheduled to run from 10am to 5pm.</p>
