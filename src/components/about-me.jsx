...
const AboutMe = ({ onClick }) => {
  return (
    <>
      ...
      <p>From Tuesday the1st of September 2020 I am  returning to  Co. Fermanagh  to work in my home based private practice which is located 9 miles from Enniskillen in Maguiresbridge,   Co. Fermanagh - see <a href="/" onClick={ onClick } data-name="contact" >contact</a> page for location.</p>
